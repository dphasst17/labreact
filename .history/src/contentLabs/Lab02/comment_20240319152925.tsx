import { Avatar, Code,User } from "@nextui-org/react";
interface Data {
  id: string,
  name: string;
  urlImg: string;
...
const Comment = () => {
  return <>
    <div className="w-full flex flex-wrap">
      {data.map((data: Data) =>
        <Code key={data.id} className="w-4/5 flex items-center bg-opacity-50  rounded p-2 my-2">
          <Avatar className="mx-2" src={data.urlImg} />
          <div>
